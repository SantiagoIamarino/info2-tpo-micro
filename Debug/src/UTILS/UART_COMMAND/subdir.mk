...
CPP_SRCS += \
../src/UTILS/UART_COMMAND/UARTCOMMAND.cpp 

CPP_DEPS += \
./src/UTILS/UART_COMMAND/UARTCOMMAND.d 

OBJS += \
./src/UTILS/UART_COMMAND/UARTCOMMAND.o 


# Each subdirectory must supply rules for building sources it contributes
src/UTILS/UART_COMMAND/%.o: ../src/UTILS/UART_COMMAND/%.cpp src/UTILS/UART_COMMAND/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-src-2f-UTILS-2f-UART_COMMAND

clean-src-2f-UTILS-2f-UART_COMMAND:
	-$(RM) ./src/UTILS/UART_COMMAND/UARTCOMMAND.d ./src/UTILS/UART_COMMAND/UARTCOMMAND.o

.PHONY: clean-src-2f-UTILS-2f-UART_COMMAND
